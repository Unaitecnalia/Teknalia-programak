...
for i, (archivo_fibra, archivo_galga) in enumerate(zip(archivos_fibra, archivos_galga), start=1):
    ...
    # Calcular la media de los primeros 10 valores de df_ensayo
    ...
    # Invertir la columna específica de df_ensayo si la media en la mitad es mayor que la media de los primeros 10
    ...
    for i, columna_galgas in enumerate(columnas_galgas):
        ...
        ax.set_ylabel("Longitud de onda de luz [nm]", color='blue')
        ...
        ax2 = ax.twinx()
        ax2.set_ylabel("Galga microstrains", color='red')
